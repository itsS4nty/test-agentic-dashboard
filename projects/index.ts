...
import { avisosDeCaducidad } from './avisos_de_caducidad/index.ts';

/** Orden de registro. Añadir un proyecto nuevo es añadirlo aquí. */
export const allProjects: ProjectModule[] = [dispositivo, bugs, facturas, soporte, plataforma, avisosDeCaducidad];
